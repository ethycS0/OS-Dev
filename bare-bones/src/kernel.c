...
#if !defined(__i386__)
#error "This tutorial needs to be compiled witha ix86-elf compiler"
#endif
...
// }
//
void terminal_putentryat(char c, uint8_t terminal_color, size_t x, size_t y) {
    const size_t index = y * VGA_WIDTH + x;
...
void kernel_main(void) {
    ...
    terminal_writestring("ethycS", VGA_COLOR_BLUE);
}
